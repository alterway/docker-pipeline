...
#
# Job "delete_down".
# Delete all containers of a service, and volumes and images.
#
# Parameters:
#   --service
#   --project-name
...
finalOutputInfo+=("Stage: deploy / Job: delete containers")
finalOutputInfo+=("Delete the container of the ${SERVICE} service...")
finalOutputInfo+=("")
...
echo "We remove all images"
run_cmd "make -s compose CMD='down -v --rmi all'"