...
echo "CMD:: docker network create ${NETWORK_ENCRYPT} --driver=${NETWORK_DRIVER} ${NETWORK_ATTACHABLE} ${NETWORK_SUBNET} ${NETWORK_LABELS} --label com.docker.stack.namespace=${PROJECT_NAME} ${NETWORK_NAME}"
